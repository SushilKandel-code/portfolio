        ...
        <section id="home" className="section">
            ...
            <div className="homeContent">
                ...
                <div className='content'>
                    <br></br>
                    <br></br>
                   <p style={{fontSize: '20px', textAlign: 'justify', padding: '20px'}}>A passionate Developer who loves turning ideas into reality through clean code, user‑friendly interfaces, and scalable solutions.<br></br>
