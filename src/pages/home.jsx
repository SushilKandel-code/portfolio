                ...
                <div className="profileContent">
                    ...
                    <div className="content">
                        <p>
                            ...
                            clean code, user‑friendly interfaces, and scalable solutions. <br /><br/>
                            I specialize in building modern, responsive web applications using
                            JavaScript, React, and Node.js. My mission is to create software
                            that not only works, but also feels intuitive and enjoyable to use.
                        </p>
                    </div>
                </div>
            </div>
